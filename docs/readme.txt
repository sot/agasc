    ...
    - Version 1.8, with an issue date of 11 July 2024.
...
this set of FITS (Flexible Image Transport System) files.  This
issue, Version 1.8, corresponds to the AGASC as completed 11 July 2024.

AGASC1.8 can be roughly considered as the superset of the best data
available for each of 18865968 listed stars, taken from the following
catalogs: GSC 1.1, PPM, Tycho, ACT, Tycho-2, GSC-ACT, and Gaia DR3.
Additional derived quantities are included that are useful for Chandra
operations, primarily the expected magnitude in the Chandra Aspect Camera
(Ball Aerospace & Technologies Corp).  Further details of AGASC1.8 history and
...
have matched.
		...
		3. SUMMARY OF THE AGASC1.8 FORMAT
...
1    MAG_CATID - unsigned integer identifying the source of the
    mag, mag_err, and mag_band.  Codes are the same as listed for POS_CATID.
    There is no default value.
...
4    XREF_ID1 - long integer with the highest significant 32 bits of the
    Gaia DR3 ID. Default value of -1.
...
4    XREF_ID5 - long integer with the lowest significant 32 bits of the
    Gaia DR3 ID. Default value of -9999.
