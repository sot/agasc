...
organization, format, and data in the AGASC1.7.  The content and data
sources for the AGASC1.7 are also described.

CONTENTS:
	1. INTRODUCTION
	2. ORGANIZATION OF THE DATA FILES
	3. SUMMARY OF THE AGASC1.7 FORMAT
	4. HISTORY OF THE AGASC version 1.7
		4.1 HST GSC
...
4.8 AAVSO (American Association of Variable Star Observers) Photometric
    All-Sky Survey (APASS)

We make use of data from the AAVSO Photometric All Sky Survey, DR9,
