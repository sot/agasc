...
TEST_DATA = {
    'file_0.yml': {
        'obs': [
            {'observation_id': '2010:110:18:59:46.600', 'obsid': 56311, 'agasc_id': 563087864,
             'status': 1, 'comments': ''},
            {'observation_id': '2010:110:18:59:46.600', 'obsid': 56311, 'agasc_id': 563088952,
             'status': 1, 'comments': ''},
            {'observation_id': '2010:110:18:59:46.600', 'obsid': 56311, 'agasc_id': 563089432,
             'status': 1, 'comments': ''},
            {'observation_id': '2010:110:18:59:46.600', 'obsid': 56311, 'agasc_id': 563091784,
             'status': 1, 'comments': ''},
            {'observation_id': '2010:110:18:59:46.600', 'obsid': 56311, 'agasc_id': 563092520,
             'status': 1, 'comments': ''},
            {'observation_id': '2010:110:18:59:46.600', 'obsid': 56311, 'agasc_id': 563612488,
             'status': 1, 'comments': ''},
            {'observation_id': '2010:110:18:59:46.600', 'obsid': 56311, 'agasc_id': 563612792,
             'status': 1, 'comments': ''},
            {'observation_id': '2010:110:18:59:46.600', 'obsid': 56311, 'agasc_id': 563617352,
             'status': 1, 'comments': ''},
            {'observation_id': '2010:110:23:23:49.708', 'obsid': 56308, 'agasc_id': 806750112,
             'status': 0, 'comments': ''},
            {'observation_id': '2010:111:12:26:54.536', 'obsid': 11849, 'agasc_id': 1019348536,
             'status': 1, 'comments': 'just removed them'},
            {'observation_id': '2010:111:12:26:54.536', 'obsid': 11849, 'agasc_id': 1019350904,
             'status': 1, 'comments': 'just removed them'}
        ],
        'bad': [(77073552, 2)],
        'mags': [
    ...
    'file_4.yml': {
        'obs': [
            {'observation_id': '2010:110:14:57:43.442', 'obsid': 56314, 'agasc_id': 114950168,
             'status': 1, 'comments': 'removed because I felt like it'},
            {'observation_id': '2010:110:14:57:43.442', 'obsid': 56314, 'agasc_id': 114950584,
             'status': 1, 'comments': 'removed because I felt like it'},
            {'observation_id': '2010:110:14:57:43.442', 'obsid': 56314, 'agasc_id': 114952056,
             'status': 1, 'comments': 'removed because I felt like it'},
            {'observation_id': '2010:110:14:57:43.442', 'obsid': 56314, 'agasc_id': 114952792,
             'status': 1, 'comments': 'removed because I felt like it'},
            {'observation_id': '2010:110:14:57:43.442', 'obsid': 56314, 'agasc_id': 114952824,
             'status': 1, 'comments': 'removed because I felt like it'},
            {'observation_id': '2010:110:14:57:43.442', 'obsid': 56314, 'agasc_id': 114955056,
             'status': 1, 'comments': 'removed because I felt like it'},
            {'observation_id': '2010:110:14:57:43.442', 'obsid': 56314, 'agasc_id': 114956608,
             'status': 1, 'comments': 'removed because I felt like it'},
            {'observation_id': '2010:110:14:57:43.442', 'obsid': 56314, 'agasc_id': 115347520,
             'status': 1, 'comments': 'removed because I felt like it'}
        ],
    ...
    'file_5.yml': {
        ...
        'mags': []},
    'file_6.yml': {
        'obs': [{'observation_id': '2010:110:14:57:43.442', 'obsid': 56314, 'agasc_id': 114950168,
                 'status': 1, 'comments': ''}],
        'bad': [],
        'mags': []},
    'file_7.yml': {
...
def test_parse_args_obs(monkeypatch):
    ...
    ref = {'obs': [{'observation_id': '2010:110:14:57:43.442', 'obsid': 56314, 'agasc_id': 2,
        ...
        if 'path' in kwargs and kwargs['path'] == 'obs':
            ...
            ref = table.Table(np.array([
                ...
                dtype=[('obsid', '<i4'), ('agasc_id', '<i4'), ('status', '<i4'),
                       ('comments', '<U80'), ('observation_id', '<U21')]))
            print(ref)
            print(args[0])
